    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
      <div class="px-4 py-6 sm:px-0">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
          <h1 class="text-2xl font-semibold text-dark-gray mb-4 sm:mb-0">Minhas Receitas</h1>
          <Button @click="goToCreateRecipe" variant="primary">
            Nova Receita
          </Button>
        </div>
            ...
            <ul v-else class="divide-y divide-gray-200">
              ...
              >
                <div class="flex items-center justify-between">
                  <div class="flex items-center cursor-pointer" @click="goToRecipeDetail(recipe.id)">
                    <div>
                      ...
                      <p class="text-sm text-gray-500">
                        Criada em: {{ new Date(recipe.criado_em || '').toLocaleDateString() }}
                      </p>
                    </div>
                  </div>
